...
public class MarineFishCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject marineFishCamera;
	float cameraAngleX=185f;
	...
	void Update(){
		...
		marineFishCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
